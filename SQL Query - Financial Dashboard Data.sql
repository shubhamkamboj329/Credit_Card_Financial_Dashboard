...
COPY cc_detail
FROM 'D:\PowerBI Project Credit Card\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\PowerBI Project Credit Card\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'D:\PowerBI Project Credit Card\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\PowerBI Project Credit Card\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
